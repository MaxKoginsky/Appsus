    ...
    template: `
        <section class="menu">
            <div class="mail-menu" :class="isOpen? 'menu-open' : 'menu-close'">
                ...
                <ul>
                    <li class="menu-tab" :class="tab === 'Inbox' ? 'is-selected' : ''" 
                        @click="updateSelectedTab">
                        <i class="fa fa-inbox" aria-hidden="true"></i>
                        <p>Inbox</p>
                    </li>
                    <li class="menu-tab" :class="tab === 'Starred' ? 'is-selected' : ''" 
                        @click="updateSelectedTab">
                        <i class="fa fa-star-o" aria-hidden="true"></i>
                        <p>Starred</p>
                    </li>
                    <li class="menu-tab" :class="tab === 'Sent' ? 'is-selected' : ''" 
                        @click="updateSelectedTab">
                        <i class="fa fa-paper-plane-o" aria-hidden="true"></i>
                        <p>Sent</p>
                    </li>
                    <li class="menu-tab" :class="tab === 'Draft' ? 'is-selected' : ''" 
                        @click="updateSelectedTab">
